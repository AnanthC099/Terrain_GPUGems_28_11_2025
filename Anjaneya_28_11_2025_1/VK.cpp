...
const float gCameraMoveSpeed = 20.0f;
const float gCameraRotationSpeed = glm::radians(2.0f);
...
VkResult UpdateClipmapLevels(const glm::vec3& cameraPosition)
{
        if(gClipmapAttributeSources[CLIPMAP_ATTRIBUTE_HEIGHT].width == 0)
        {
                return VK_ERROR_INITIALIZATION_FAILED;
...
VkResult InitializeClipmapResources(void)
{
	...
	if(vkResult != VK_SUCCESS)
	{
        ...
        glm::vec2 cameraSample = glm::vec2(gCameraPosition.x, gCameraPosition.z) / gClipmapBaseWorldSpacing;
        gClipmapCameraSample.x = (int)floorf(cameraSample.x);
        gClipmapCameraSample.y = (int)floorf(cameraSample.y);
...
void update(void)
{
        ...
        {
                gCameraYawRadians -= gCameraRotationSpeed;
        ...
        {
                gCameraPitchRadians -= gCameraRotationSpeed;
                orientationChanged = true;
        }
        ...
        {
                movement += glm::vec3(0.0f, 0.0f, -gCameraMoveSpeed);
        }
        ...
        {
                movement += glm::vec3(-gCameraMoveSpeed, 0.0f, 0.0f);
        }
        ...
        {
                movement += glm::vec3(0.0f, -gCameraMoveSpeed, 0.0f);
        }
